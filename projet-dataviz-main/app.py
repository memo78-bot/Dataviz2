...
# Custom CSS - Premium SaaS Dashboard Style
st.markdown("""
...
<style>
    ...
    /* Hide Streamlit branding for standalone app feel */
    ...
    .metric-card-premium:hover {
        border-color: #10B981;
        box-shadow: 0 4px 6px rgba(16, 185, 129, 0.1), 0 8px 16px rgba(0, 0, 0, 0.06);
    }
